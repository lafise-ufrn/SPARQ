%% SPARQ - SCRIPT DE PROCESSAMENTO GENERICO EM LOTE (LEGADO)
% Este script preserva o antigo fluxo configuravel por codigo. Para o uso
% interativo recomendado, execute main.m ou SPARQ_GUI.
%
% COMO USAR:
...
config.dataFolder = "C:\pesquisa\dados_eletro\exp_esteira_odor\outputs\rato4";
...
config.loader.lfpVariable = "LFP";              % matriz de sinal (LFP ou nao)
config.loader.samplingRateVariable = "";      % frequencia em Hz
% Para usar uma frequencia fixa, deixe a linha acima = "" e informe, ex.: 1000, na linha abaixo.
...
% Abre as quatro figuras padrao do fluxo visual e, quando solicitadas acima,
% acrescenta uma figura para o sinal concatenado e/ou uma para o sinal com NaN.
% Ao salvar, os PNGs opcionais usam os sufixos _concat e _nan.
